    ...
    <template v-else-if="user">
      ...
      <div class="bg-white rounded-xl border border-zinc-100 p-8 mb-10 shadow-sm">
        ...
        <div v-if="isOwnProfile" class="flex gap-3 pt-4 border-t border-zinc-100">
          ...
          <RouterLink to="/my-comments" class="flex-1 flex items-center justify-center gap-2 px-4 py-2.5 text-sm font-medium text-zinc-600 bg-zinc-50 rounded-xl hover:bg-zinc-100 hover:text-zinc-900 transition-colors duration-200">
            <svg class="w-4 h-4" fill="none" stroke="currentColor" viewBox="0 0 24 24"><path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M8 12h.01M12 12h.01M16 12h.01M21 12c0 4.418-4.03 8-9 8a9.863 9.863 0 01-4.255-.949L3 20l1.395-3.72C3.102 15.328 3 14.644 3 14c0-4.418 4.03-8 9-8s9 3.582 9 8z"/></svg>
            我的评论
          </RouterLink>
